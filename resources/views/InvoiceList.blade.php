...
<div class="content-page">
    <div class="row">
        <div class="col">
            <div class="page-title-box">
                <h2 class="page-title font-weight-bold">Vendor Invocie Lists</h2>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-4">Manage Vendor Invocie</h4>
                                ...
                                <table id="row-callback-datatable" class="table dt-responsive nowrap w-100 dataTable no-footer dtr-inline collapsed table-bordered" role="grid" aria-describedby="row-callback-datatable_info" style="width: 1250px;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="row-callback-datatable" rowspan="1" colspan="1" style="width: 300.4px;" aria-label="Position: activate to sort column ascending">Name/Phone/Address</th>
                                            <th class="sorting" tabindex="0" aria-controls="row-callback-datatable" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Office: activate to sort column ascending">Bank Details</th>
                                            <th class="sorting" tabindex="0" aria-controls="row-callback-datatable" rowspan="1" colspan="1" style="width: 74.4px;" aria-label="Age: activate to sort column ascending">Invoice</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled">
                                                    <li><b>Name :</b><span> {{$invoice->name}}</span></li>
                                                    <li><b>Phone :</b><span> {{$invoice->phone_number}}</span></li>
                                                    <li><b>Address :</b> <span> {{$invoice->address}}</span></li>
                                                    <li><b>Invoice Number :</b> <span> {{$invoice->invoice_number}}</span></li>
                                                </ul>
                                            </td>

                                            <td>
                                                <ul class="list-unstyled">
                                                    <li><b>A/C Holder Name :</b><span> {{$invoice->account_holder_name}}</span></li>
                                                    <li><b>A/C Number :</b> <span> {{$invoice->account_number}}</span></li>
                                                    <li><b>Bank Name :</b><span> {{$invoice->bank_name}}</span></li>
                                                    <li><b>Branch address :</b> <span> {{$invoice->branch_address}}</span></li>
                                                    <li><b>IFSC Code :</b> <span> {{$invoice->ifsc_code}}</span></li>
                                                </ul>
                                            </td>
                                            <td>
                                                <ul class="list-unstyled">
                                                    <li><b>Invoice Number :</b> <span> {{$invoice->invoice_number}}</span></li>
                                                    <li><b>Item :</b><span> {{$invoice->item_description}}</span></li>
                                                    <li><b>Amount :</b><span> {{$invoice->net_amount}}</span></li>
                                                </ul>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{{ route('invoiceList', base64_encode($invoice->id)) }}" target="_blank">
